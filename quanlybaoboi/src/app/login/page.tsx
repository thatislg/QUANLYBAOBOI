            ...
            <div>
              ...
              >
                ...
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.24 10.285V14.4h6.806c-.275 1.765-2.056 5.174-6.806 5.174-4.095 0-7.439-3.389-7.439-7.574s3.345-7.574 7.439-7.574c2.33 0 3.814.924 4.796 1.805l3.348-3.348C17.955 1.738 15.228 0 12.24 0c-6.635 0-12 5.365-12 12s5.365 12 12 12 12-5.365 12-12c0-1.248-.228-2.44-.654-3.535h-6.806z"/>
                </svg>
              </a>
            </div>
